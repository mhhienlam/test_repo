...
author: |
  | Minh Hien Lam
  | m.h.lam@students.uu.nl
  | http://www.github.com/mhhienlam
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
GrowthSW$treat <- ifelse (GrowthSW$revolutions>0, "Revolution > 0","Revolution=0")
summary_table <- datasummary(~ growth + rgdp60, data = GrowthSW, groups = "treat",
